<?php
    ...
    $date_of_ap = $_POST['date_of_ap'] ?? "";
    $doc_name = $_POST['doc_name'] ?? "";
    $timeslot_id = $_POST['timeslot_id'] ?? "";
    $symptoms = $_POST['symptoms'] ?? "";


    $sql =  "INSERT INTO `kikahospital`.`appointments` (`id`,`first_name`,`middle_name`,`last_name`,`gender`,`blood_group`,`date_of_ap`,
    `doc_name`,`timeslot_id`,`symptoms`) 
    VALUES ("$id","$first_name","$middle_name","$last_name","$gender","$blood_group","$date_of_ap","$doc_name","$timeslot_id","$symptoms");";
